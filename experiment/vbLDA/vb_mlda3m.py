...
def save_model( save_dir, a, b1, b2, b3 ,m, k):
    try:
        os.mkdir( save_dir )
    except:
        pass
...
if __name__ == "__main__":
    ...
    D = data[0].shape[0]
    alpha0, betax1, betax2, betax3 = 0.5, 1.0, 1.0, 1.0
    ...
    for t in range(T):
        ...
        if train_mode:
            save_model( "./learn_result", dig_alpha, dig_beta1, dig_beta2, dig_beta3, len(data), K)
