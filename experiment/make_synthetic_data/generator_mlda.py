...
@click.option('--vacabulary_size', help = '単語数', type=int, default = 15)
@click.option('--hist_num', help = '文書数（ヒストグラムの列数）', type=int, default = 20)
@click.option('--term_per_doc', help = '文書ごとの単語数（ヒストグラムの行数）', type=int, default = 15)
