...
class MAVITM(nn.Module):
    def __init__(self,
        ...
        self.inference = joint_encoder(joint_input, 50, 50, encoder_noise)
        self.mean = hidden(50, topics, eps=batchnorm_eps, momentum=batchnorm_momentum)
        self.logvar = hidden(50, topics, eps=batchnorm_eps, momentum=batchnorm_momentum)
