...
class MAVITM(nn.Module):
    def __init__(self,
        ...
        self.inference = joint_encoder(joint_input, 200, 220, encoder_noise)
        self.mean = hidden(220, topics, eps=batchnorm_eps, momentum=batchnorm_momentum)
        self.logvar = hidden(220, topics, eps=batchnorm_eps, momentum=batchnorm_momentum)
