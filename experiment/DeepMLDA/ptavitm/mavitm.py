...
class MAVITM(nn.Module):
    def __init__(self,
        ...
        self.inference = joint_encoder(joint_input, 270, 270, encoder_noise)
        self.mean = hidden(270, topics, eps=batchnorm_eps, momentum=batchnorm_momentum)
        self.logvar = hidden(270, topics, eps=batchnorm_eps, momentum=batchnorm_momentum)
